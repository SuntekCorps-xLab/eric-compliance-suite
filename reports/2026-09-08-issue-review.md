...
- 本机对固定公开 PNG 的下载尝试因 DNS 返回非公网地址而被安全规则拒绝，未绕过规则。[Linux CI](https://github.com/SuntekCorps-xLab/eric-compliance-suite/actions/runs/34181939554/job/101922631550) 对固定公开 PNG 的真实 HTTPS 下载及字节比对已通过，不调用 ERiC；三平台 CI 结果在合入前核对。
